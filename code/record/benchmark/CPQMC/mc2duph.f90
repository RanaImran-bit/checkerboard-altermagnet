...
do m=1,NSTATES
    k=k+1
    superk_xo(k+NSTATES*0,1)=swave(m)
    superk_xo(k+NSTATES*1,1)=pwave(m)
    superk_xo(k+NSTATES*2,1)=dwave(m)
    superk_xo(k+NSTATES*3,1)=sowave(m)
    superk_xo(k+NSTATES*4,1)=sbwave(m)
    superk_xo(k+NSTATES*5,1)=pbwave(m)
    superk_xo(k+NSTATES*6,1)=dbwave(m)
    superk_xo(k+NSTATES*7,1)=pdsfbd1(m)
    superk_xo(k+NSTATES*8,1)=pdsfbd2(m)
    superk_xo(k+NSTATES*9,1)=pdsfbd12(m)
    superk_xo(k+NSTATES*10,1)=dd1wave(m)
    superk_xo(k+NSTATES*11,1)=dd2wave(m)
    superk_xo(k+NSTATES*12,1)=dd12wave(m)
    superk_xo(k+NSTATES*13,1)=puupxwave(m)
    superk_xo(k+NSTATES*14,1)=pddpxwave(m)
    superk_xo(k+NSTATES*15,1)=pudpxwave(m)
    superk_xo(k+NSTATES*16,1)=puupywave(m)
    superk_xo(k+NSTATES*17,1)=pddpywave(m)
    superk_xo(k+NSTATES*18,1)=pudpywave(m)
    superk_xo(k+NSTATES*19,1)=pbdx2y2d1(m)
    superk_xo(k+NSTATES*20,1)=pbdx2y2d2(m)
    superk_xo(k+NSTATES*21,1)=pbdx2y2d12(m)
end do
...
k = ntypes*NSTATES + (j-1)*NSTATES*NSTATES + (m-1)*NSTATES + n
...
do m=1,NSTATES
    k=k+1
    ave_cor(k+NSTATES*0)=gxk_up(m)
    ave_cor(k+NSTATES*1)=gxk_dn(m)
    ave_cor(k+NSTATES*2)=nk_up(m)
    ave_cor(k+NSTATES*3)=nk_dn(m)
    ave_cor(k+NSTATES*4)=nk_w(m)
    ave_cor(k+NSTATES*5)=cdw(m)
    ave_cor(k+NSTATES*6)=sdwz(m)
    ave_cor(k+NSTATES*7)=sdwx(m)
    ave_cor(k+NSTATES*8)=pmdf(m)
    ave_cor(k+NSTATES*9)=dsf(m)
    ave_cor(k+NSTATES*10)=swave(m)
    ave_cor(k+NSTATES*11)=pwave(m)
    ave_cor(k+NSTATES*12)=dwave(m)
    ave_cor(k+NSTATES*13)=sowave(m)
    ave_cor(k+NSTATES*14)=sbwave(m)
    ave_cor(k+NSTATES*15)=pbwave(m)
    ave_cor(k+NSTATES*16)=dbwave(m)
    ave_cor(k+NSTATES*17)=pdsfbd1(m)
    ave_cor(k+NSTATES*18)=pdsfbd2(m)
    ave_cor(k+NSTATES*19)=pdsfbd12(m)
    ave_cor(k+NSTATES*20)=dd1wave(m)
    ave_cor(k+NSTATES*21)=dd2wave(m)
    ave_cor(k+NSTATES*22)=dd12wave(m)
    ave_cor(k+NSTATES*23)=puupxwave(m)
    ave_cor(k+NSTATES*24)=pddpxwave(m)
    ave_cor(k+NSTATES*25)=pudpxwave(m)
    ave_cor(k+NSTATES*26)=puupywave(m)
    ave_cor(k+NSTATES*27)=pddpywave(m)
    ave_cor(k+NSTATES*28)=pudpywave(m)
    ave_cor(k+NSTATES*29)=pbdx2y2d1(m)
    ave_cor(k+NSTATES*30)=pbdx2y2d2(m)
    ave_cor(k+NSTATES*31)=pbdx2y2d12(m)
end do
